...
function HistoryRegister(props) {
  ...
  return (
    <figure className={`${(isSender) ? "border-red-600" : "border-green-600"} border-l-4 flex items-center w-full px-6 bg-third rounded-lg py-3 lg:py-2 justify-between lg:bg-black lg:bg-opacity-5`}>
